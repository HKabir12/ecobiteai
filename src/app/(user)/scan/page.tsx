...
const UploadForm: React.FC<UploadFormProps> = ({ userId }) => {
  ...
  // Resize & grayscale to improve OCR accuracy
  const preprocessImage = (file: File, maxWidth = 1024): Promise<Blob> =>
    new Promise((resolve) => {
      const img = new Image();
  ...
  const handleScan = async () => {
    ...
    try {
      ...
      // Split text into lines and map to parsed items
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-white shadow-lg rounded-2xl border border-gray-200 mt-6">

      ...
      <div className="max-w-7xl mx-auto px-4 py-10 grid md:grid-cols-3 gap-6">
        ...
        <div>
          ...
          <p className="text-gray-600 text-sm">
            Smart food management for a sustainable future. Track. Save. Nourish.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-gray-700">
            ...
            <li><Link href="/logs" className="hover:text-green-600">Food Logs</Link></li>
            <li><Link href="/resources" className="hover:text-green-600">Resources</Link></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <p className="text-gray-700 text-sm mt-1">Made for SDG 2 & SDG 12 Hackathon</p>
        </div>
      </div>
